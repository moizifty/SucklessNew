 ...
 *
 * TODO
 * make it so that the current workspace
 * appears first in the tags on the bar
 * 
 * make a new bar element which only
 * displays the current tag
 *
 * refactor code and read it through
 *
 * add more bar element settings
 */
#include <errno.h>
#include <locale.h>
#include <signal.h>
...
static BarElement getbarelement(ElementType et);
